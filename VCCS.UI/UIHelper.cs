...
namespace VCCS.UI
{
    public class UIHelper
    {
        ...
        public static void DoOnUIThread(Control element, Action action)
        {
            element.Invoke((SendOrPostCallback)delegate { action(); }, null);
        }
        ...
        public static byte[] LoadImageBytes(Uri imageURI)
        {
            if (imageURI != null)
            {
                StreamResourceInfo streamInfo = System.Windows.Application.GetResourceStream(imageURI);
        ...
        public static Point ScreenCoordinatesToWPF(Visual visual, System.Windows.Point screenPoint)
        {
